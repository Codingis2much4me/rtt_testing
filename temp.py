            ...
            with ping_lock:
                for client_address, client_socket in list(clients.items()):
                    try:
                        ...
                        # Put data into the plot_data_queue for plotting
                        plot_data_queue.put((rtt_values, cluster_centers, labels))
    ...
    while True:
        try:
            if not plot_data_queue.empty():
                rtt_values, cluster_centers, labels = plot_data_queue.get()
